 ...
 */
  ...
  function($animate ,  $injector,   $modalStack) {
    ...
    return {
      restrict: 'EA',
      replace: true,
      templateUrl: 'static/app/lib/angular-ui-bootstrap/template/modal/backdrop.html',
  ...
  function($modalStack ,  $q ,  $animate,   $injector) {
    ...
    return {
      ...
      templateUrl: function(tElement, tAttrs) {
        return tAttrs.templateUrl || 'static/app/lib/angular-ui-bootstrap/template/modal/window.html';
      },
      link: function(scope, element, attrs) {
